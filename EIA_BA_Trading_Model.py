...
df_BAA = pd.read_excel('data/BA_Codes_930.xlsx', sheetname = 'Table 1', header = 4)
df_BAA.rename(columns={'etag ID': 'BAA_Acronym', 'Entity Name': 'BAA_Name','NCR_ID#': 'NRC_ID', 'Region': 'Region'}, inplace=True)
...
df_trade_all_stack_2016 = pd.read_pickle('data/trade_all_2016.pkl')
df_trade = pd.read_pickle('data/trade.pkl')
df_dem_2016 = pd.read_pickle('data/2016_dem.pkl')
df_net_gen_2016 = pd.read_pickle('data/2016_net_gen.pkl')
df_tot_int_2016 = pd.read_pickle('data/2016_total_interchange.pkl')
...
#Note the order of terms here is reversed from Qu et al (2018)
#We believe their equation is incorrect, following up for confirmation
...
df_H = pd.DataFrame(H)
df_H.to_csv('output/H_matrix.csv')
#%%
...
#Subset to select only top 10 BAs
